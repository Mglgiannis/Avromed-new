...
const StyledAppStoreButton = styled(Button)(({ theme }) => ({
  ...
  background: `linear-gradient(90deg, ${theme.palette.grey[400]} 0%, ${theme.palette.common.black} 50%)`,
...
export default function Footer() {
  ...
  const simpleFooter = (
    <Container sx={{ py: 1, textAlign: 'center' }}>
      ...
      <Typography variant="caption" component="div" sx={{ color: 'text.primary' }}>
        © 2023. AVRO MED Уламжлалт Анагаах Ухааны Эмнэлэг
      </Typography>
      <Link variant="body2"  href="https://www.facebook.com/batmyagmar.itgelt.3" sx={{ color: 'text.secondary' }} >
                 Developed by Batmyagmar Itgelt
      </Link>
    </Container>
  );
  ...
  //                Бид чанартай, түргэн шуурхай, хариуцлагатай үйлчилнэ.
  //               </Typography>
  //             </Stack>
